...
5. Do **not** delete anything. This skill audits; for removal, hand off to `flag-cleanup`, which walks through code-cleanup, archive, and (optionally) permanent delete.
