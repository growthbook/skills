...
- **`predefined` is a closed list**, and the plausible-looking names outside it (`last14Days`, `last6Months`, `last3Months`) are all rejected. The whole list: `today`, `yesterday`, `last7Days`, `last30Days`, `last90Days`, `last12Months`, `lastCalendarYear`, `customLookback`, `customDateRange`. Every other window is `customLookback` with `lookbackValue` and `lookbackUnit` (`hour`, `day`, `week`, `month`) — six months is `{ "predefined": "customLookback", "lookbackValue": 6, "lookbackUnit": "month" }`.
