...
- **Read-only.** Never POST, PUT, or DELETE from this skill. Route chart-running to `references/analytics-explore.md`, metric creation to `references/metric-create.md`, and legacy-to-fact-table migration to `references/metric-migrate.md`.
