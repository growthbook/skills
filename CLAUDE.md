...
- The public Product Analytics surface is `GET /api/v1/product-analytics/search`, `GET /api/v1/product-analytics/columns`, `POST /api/v1/product-analytics/column-values`, the four `/api/v1/product-analytics/*-exploration` POSTs (metric, fact table, data source, and funnel), and `GET /api/v1/product-analytics/explorations/:id` (analytics-explore, metric-search)
